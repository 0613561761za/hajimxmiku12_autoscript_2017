...
wget -P /etc/squid3/ "https://raw.githubusercontent.com/hajimxmiku/hajimxmiku12_autoscript_2017/master/squid.conf"
...
#install menu
wget https://raw.githubusercontent.com/hajimxmiku/hajimxmiku12_autoscript_2017/master/menu
wget https://raw.githubusercontent.com/hajimxmiku/hajimxmiku12_autoscript_2017/master/user-list
wget https://raw.githubusercontent.com/hajimxmiku/hajimxmiku12_autoscript_2017/master/monssh
wget https://raw.githubusercontent.com/hajimxmiku/hajimxmiku12_autoscript_2017/master/status
...
wget -O /etc/issue.net " https://raw.githubusercontent.com/hajimxmiku/hajimxmiku12_autoscript_2017/master/banner"
...
"
#bonus block torrent
wget https://raw.githubusercontent.com/hajimxmiku/hajimxmiku12_autoscript_2017/master/torrent.sh
chmod +x  torrent.sh
./torrent.sh

#add user
useradd -m -g users -s /bin/bash mklet
echo "miku:miku" | chpasswd
...
echo "===============================================--"
echo "                             "
echo "  === AUTOSCRIPT FROM HAJIMXMIKU12 === "
...
echo "For testing use username:miku and pass: miku"
echo "TORRENT PORT HAS BEEN BLOCKED BY SCRIPT"
